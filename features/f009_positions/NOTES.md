...
- 2026-05-08: `MarketDataFetcher` replaces `QuoteFetcher` as the primary interface. `QuoteFetcher` kept as deprecated for backward compat. `YahooFinanceFetcher.FetchQuote` now returns `*MarketData` instead of `*Quote`.
