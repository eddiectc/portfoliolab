# WisdomTree ETF Scraper — Progress & Findings (v1 — OLD SITE)

> **SUPERSEDED.** WisdomTree relaunched its website on 2026-08-30 (Sitecore → React/Next.js).
> This document covers the old site, which no longer exists. See the current research doc at
> `../RESEARCH.md`. Old-site sample captures live in `v1/samples/`.
