...
// Client fetches iShares pages with browser-grade TLS fingerprinting to bypass Cloudflare.
type Client struct {
...
// NewClient creates a new iShares HTTP client with CycleTLS and rate limiting.
...
// Fetch retrieves the content of an iShares page or API endpoint.
