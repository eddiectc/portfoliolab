...
- [x] **Portfolio Performance** — Equity curve (portfolio value vs net deposits), time-weighted return (TWR), annualized TWR, period selector, multi-currency FX conversion (using yfinance for prices)
